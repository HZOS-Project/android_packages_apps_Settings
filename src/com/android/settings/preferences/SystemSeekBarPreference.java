...
import com.android.internal.util.hz.HZUtils;
    ...
    private void init() {
        ...
        setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                switch (restartKey) {
                    case SYSTEM:
                        HZUtils.showSystemUiRestartDialog(mContext);
                        break;
                    case SYSTEMUI_RESTART:
                        HZUtils.showSystemRestartDialog(mContext);
                        break;
                    case SETTINGS_RESTART:
                        HZUtils.showSettingsRestartDialog(mContext);
                        break;
                    case NONE:
                    default:
                        break;
